...
class App extends Component {
    ...
    componentWillMount() {
        ...
        let csvFilePath = require("./data/cleaned_questions_set_1.csv");
        ...
        // reader.readAsText("./data/cleaned_questions_set_1.csv")
        // reader.onload = function (event) {
        //     csvFileString = event.target.result;
        //     console(csvFileString)
        // }
        parse(csvFileString, {
                header: true,
                download: false,
